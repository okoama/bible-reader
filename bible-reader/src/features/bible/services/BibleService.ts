...
const BOOK_MANIFEST: Array<{ id: string; name: string; testament: string; order: number }> = [
  ...
  { id: 'wisdom', name: 'Wisdom', testament: 'Deuterocanonical', order: 23 },
  { id: 'sirach', name: 'Sirach', testament: 'Deuterocanonical', order: 24 },
  { id: 'isaiah', name: 'Isaiah', testament: 'Old Testament', order: 25 },
  { id: 'jeremiah', name: 'Jeremiah', testament: 'Old Testament', order: 26 },
  { id: 'lamentations', name: 'Lamentations', testament: 'Old Testament', order: 27 },
  { id: 'baruch', name: 'Baruch', testament: 'Deuterocanonical', order: 28 },
  { id: 'ezekiel', name: 'Ezekiel', testament: 'Old Testament', order: 29 },
  { id: 'daniel', name: 'Daniel', testament: 'Old Testament', order: 30 },
  { id: 'hosea', name: 'Hosea', testament: 'Old Testament', order: 31 },
  { id: 'joel', name: 'Joel', testament: 'Old Testament', order: 32 },
  { id: 'amos', name: 'Amos', testament: 'Old Testament', order: 33 },
  { id: 'obadiah', name: 'Obadiah', testament: 'Old Testament', order: 34 },
  { id: 'jonah', name: 'Jonah', testament: 'Old Testament', order: 35 },
  { id: 'micah', name: 'Micah', testament: 'Old Testament', order: 36 },
  { id: 'nahum', name: 'Nahum', testament: 'Old Testament', order: 37 },
  { id: 'habakkuk', name: 'Habakkuk', testament: 'Old Testament', order: 38 },
  { id: 'zephaniah', name: 'Zephaniah', testament: 'Old Testament', order: 39 },
  { id: 'haggai', name: 'Haggai', testament: 'Old Testament', order: 40 },
  { id: 'zechariah', name: 'Zechariah', testament: 'Old Testament', order: 41 },
  { id: 'malachi', name: 'Malachi', testament: 'Old Testament', order: 42 },
  { id: 'tobit', name: 'Tobit', testament: 'Deuterocanonical', order: 43 },
  { id: 'judith', name: 'Judith', testament: 'Deuterocanonical', order: 44 },
