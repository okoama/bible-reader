    ...
    <aside className="w-72 shrink-0 border-l p-4 overflow-y-auto">
      ...
      {hasSelection ? (
        <div className="space-y-4">
          ...
          {verseHighlights.length === 0 && verseNotes.length === 0 && (
            <p className="text-sm opacity-60">
              No highlights or notes on this verse yet.
            </p>
          )}
        </div>
      ) : (
        <div className="rounded border p-4">
          ...
          <p className="mt-2 text-sm opacity-80">
            Click a verse to see highlights and notes.
          </p>
        </div>
      )}
      ...
      {selectedBook ? (
        <section className="mt-4">
          ...
          {bookmarks.length > 0 ? (
            ...
            <p className="text-sm opacity-60">No bookmarks in this book yet.</p>
          )}
        </section>
      ) : null}
      {deletingNote && (
